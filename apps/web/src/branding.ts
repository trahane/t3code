...
export const APP_BASE_NAME = injectedDesktopAppBranding?.baseName ?? HARBORDEX_BRANDING.productName;
...
export const APP_FORK_ATTRIBUTION = HARBORDEX_BRANDING.attribution;
