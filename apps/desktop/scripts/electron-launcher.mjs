// This file mostly exists because we want dev mode to say "Harbordex (Dev)" instead of "electron"
...
const APP_DISPLAY_NAME = isDevelopment ? "Harbordex (Dev)" : "Harbordex (Alpha)";
